...
> 初赛锚点：[Optimize/12](./Optimize/12.初赛冻结备忘.md) · 已落地：[Optimize/5](./Optimize/5.已完成优化摘要.md)
...
| 3 | [一致性审计](./FinalCompetition/一致性审计与回归用例.md) | C1/C2/H5 已修；余下见文档 |
| 4 | **[5.已完成优化分类总表](./Optimize/5.已完成优化摘要.md)** | 初赛按层归类的落地清单 |
| 5 | [0.优化索引](./Optimize/0.优化索引.md) | 现状一页 + 文档地图 |
...
| — | [决赛准备 Todo §1](./FinalCompetition/决赛准备Todo.md) | **决赛完整门禁 07-27**：11/11 + C1/C2/H5 + mid BATCH **3578.46** |
| — | [2.Todo](./Optimize/2.待落地优化Todo.md) | 决赛性能候选（🧊，门禁后） |
...
│   ├── 决赛准备Todo.md          ← 决赛主线
│   └── 一致性审计与回归用例.md
├── Optimize/                 初赛性能档案 + 决赛候选（0–13）
│   ├── 0.优化索引.md
│   ├── 1.TPC-C性能优化分析.md
│   ├── 2.待落地优化Todo.md      ← 决赛性能候选（🧊）
...
| 本地 / gitlab | HEAD `31e5fac`（P2 + SER 谓词预编译） |
| 本机远端 | 仅 **`gitlab`** |
| **阶段** | **决赛**：正确性门禁 → Wire v3 / SI·SER / COUNT(DISTINCT) / FLOAT32 → W=50×32 |
| 已落地清单 | **[§5](./Optimize/5.已完成优化摘要.md)**（初赛） |
