...
> 最后更新：**2026-08-01**（最新 `bc2c208` 全 PASS，Ranking **34,592**；性能锚点仍为 **37,248.4**）
...
| 文档 | 状态 | 说明 |
|------|:----:|------|
| **[08-01 OJ 性能测评报告摘要](./0801-OJ性能测评报告摘要.md)** | ✅ 最新 PASS | `bc2c208`：W=50 装载 711.11s、三窗中位 **34,592**；`c524ff8` 的 **37,248.4** 保留为性能锚点 |
...
| **[Optimize/14 优化状态与实施计划](../Optimize/14.决赛优化状态与实施计划.md)** | 🎯 现行裁决 | H3 已冻结；H4、归因与条件式性能实验 |
...
最新官方复测（2026-08-01 20:29）：`bc2c208` **全 PASS**，W=50 装载 **711.11s**（9 表、25,050,197 行），
32 客户端三轮排名中位 **34,592 NewOrder/min**。上一轮 `c524ff8` 的 **37,248.4** 继续作为性能回退锚点；H3 因仅启用在 SER SELECT 而冻结。详见
