...
> 最后更新：**2026-08-02**（最新 `5ae93e4` 全 PASS，Ranking **33,862.8**；H3/H4 已冻结，性能锚点仍为 **37,248.4**）
...
| 文档 | 状态 | 说明 |
|------|:----:|------|
| **[08-02 OJ 性能测评报告摘要](./0802-OJ性能测评报告摘要.md)** | ✅ 最新 PASS | `5ae93e4`：H4 冻结；W=50 装载 700.54s、三窗中位 **33,862.8**；性能锚点仍为 **37,248.4** |
...
| **[Optimize/14 优化状态与实施计划](../Optimize/14.决赛优化状态与实施计划.md)** | 🎯 现行裁决 | H3/H4 已冻结；归因与条件式性能实验 |
...
最新官方复测（2026-08-02 21:14）：`5ae93e4` **全 PASS**，W=50 装载 **700.54s**（9 表、25,050,905 行），
32 客户端三轮排名中位 **33,862.8 NewOrder/min**。`c524ff8` 的 **37,248.4** 继续作为性能回退锚点；H3/H4 均已冻结。详见
[08-02 OJ 性能测评报告摘要](./0802-OJ性能测评报告摘要.md)。
