...
queries = [
    "EXPLAIN ANALYZE SELECT A.a_id, B.b_id FROM A JOIN B ON A.x = B.x;",
    "EXPLAIN ANALYZE SELECT * FROM A JOIN B ON A.x = B.x;",
    "EXPLAIN ANALYZE SELECT A.a_id, B.b_id FROM A a JOIN B b ON a.x = b.x;",
]
